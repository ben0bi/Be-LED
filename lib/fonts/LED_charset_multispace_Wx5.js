...
// M
var scM=new Array();
scM.push([0,1,0,0,0,1]);
scM.push([0,1,1,0,1,1]);
scM.push([0,1,0,1,0,1]);
scM.push([0,1,0,0,0,1]);
scM.push([0,1,0,0,0,1]);
//scM = LF.mirrorV(scM);
...
// N
var scN=new Array();
scN.push([0,1,0,0,0,1]);
scN.push([0,1,1,0,0,1]);
scN.push([0,1,0,1,0,1]);
scN.push([0,1,0,0,1,1]);
scN.push([0,1,0,0,0,1]);
//scN = LF.mirrorV(scN);
...
// Q
var scQ=new Array();
scQ.push([0,0,1,1,0,0]);
scQ.push([0,1,0,0,1,0]);
scQ.push([0,1,0,0,1,0]);
scQ.push([0,1,0,0,1,0]);
scQ.push([0,0,1,1,0,1]);
//scQ = LF.mirrorV(scQ);
...
// U
var scU=new Array();
scU.push([0,1,0,0,0,1]);
scU.push([0,1,0,0,0,1]);
scU.push([0,1,0,0,0,1]);
scU.push([0,1,0,0,0,1]);
scU.push([0,0,1,1,1,0]);
//scU = LF.mirrorV(scU);
scr[30] = scr["u"] = scr["U"] = scU;

// V
var scV=new Array();
scV.push([0,1,0,0,0,1]);
scV.push([0,1,0,0,0,1]);
scV.push([0,1,0,0,0,1]);
scV.push([0,0,1,0,1,0]);
scV.push([0,0,0,1,0,0]);
//scV = LF.mirrorV(scV);
scr[31] = scr["v"] = scr["V"] = scV;

// W
var scW=new Array();
scW.push([0,1,0,0,0,1]);
scW.push([0,1,0,0,0,1]);
scW.push([0,1,0,1,0,1]);
scW.push([0,1,1,0,1,1]);
scW.push([0,1,0,0,0,1]);
//scW = LF.mirrorV(scW);
...
// X
var scX=new Array();
scX.push([0,0,1,0,0,0,1]);
scX.push([0,0,0,1,0,1,0]);
scX.push([0,0,0,0,1,0,0]);
scX.push([0,0,0,1,0,1,0]);
scX.push([0,0,1,0,0,0,1]);
//scX = LF.mirrorV(scX);
...
// Y
var scY=new Array();
scY.push([0,1,0,0,0,1]);
scY.push([0,0,1,0,1,0]);
scY.push([0,0,0,1,0,0]);
scY.push([0,0,0,1,0,0]);
scY.push([0,0,0,1,0,0]);
//scY = LF.mirrorV(scY);
...
// Z
var scZ=new Array();
scZ.push([0,1,1,1,1,1]);
scZ.push([0,0,0,0,1,0]);
scZ.push([0,0,0,1,0,0]);
scZ.push([0,0,1,0,0,0]);
scZ.push([0,1,1,1,1,1]);
//scZ = LF.mirrorV(scZ);
...
scSemicolon.push([0,0,0,0]);
scSemicolon.push([0,0,1,0]);
scSemicolon.push([0,1,0,0]);
//scSemicolon = LF.mirrorV(scSemicolon);
scr[40] = scr[";"]= scSemicolon;

// slash
var scSlash=new Array();
scSlash.push([0,0,0,0,0,1]);
scSlash.push([0,0,0,0,1,0]);
scSlash.push([0,0,0,1,0,0]);
scSlash.push([0,0,1,0,0,0]);
scSlash.push([0,1,0,0,0,0]);
...
// backslash
var scBS=new Array();
scBS.push([0,1,0,0,0,0]);
scBS.push([0,0,1,0,0,0]);
scBS.push([0,0,0,1,0,0]);
scBS.push([0,0,0,0,1,0]);
scBS.push([0,0,0,0,0,1]);
